...
/// </summary>
public sealed class SingleAddonInstallationWorker : ISingleAddonInstallationWorker
{
    ...
    public SingleAddonInstallationWorker(
        ...
        CancellationToken cancellationToken)
    {
        try
        {
            ...
            return await InstallCoreAsync(addon, installationMethod, progress, cancellationToken);
        }
    ...
    public async Task<InstallResult> ReplaceOneAsync(
        Addon addon,
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            cancellationToken.ThrowIfCancellationRequested();
            return await ReplaceCoreAsync(addon, operationName, installationMethod, progress, cancellationToken);
        }
        catch (OperationCanceledException ex)
        {
            return InstallResult.Canceled(
                $"{operationName} of addon {addon.Name} was canceled before it started.",
                ex);
        }
    }

    public InstallResult DeleteOne(
        Addon addon,
        IProgress<InstallProgress>? progress,
        CancellationToken cancellationToken)
    {
